/*	@(#)volcrc.c	1.2	94/04/06 11:49:25 */
/*
 ...
 * buffer full at a time.  Initialize crc to 0 for XMODEM, -1 for CCITT.
 * Written by Mark G. Mendel, Network Systems Corporation (see net news
 * article net.sources:<68@hyper.UUCP>).
 */
