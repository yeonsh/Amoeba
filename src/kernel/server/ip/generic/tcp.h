...
#define TCP_MAX_SND_WND_SIZE	(16*1024)
#endif
...
#define TCP_MAX_RCV_WND_SIZE	(TCP_MIN_RCV_WND_SIZE + 4*1024)
#endif
...
int tcp_ioctl ARGS(( int fd, unsigned long req));
...
/*
 * $PchId: tcp.h,v 1.7 1995/11/24 10:09:02 philip Exp $
 */
