...
int ip_port;
{
	...
	if (!(port->ip_flags & IPF_NETMASKSET)) {
		port->ip_subnetmask= HTONL(0xffffff00L);
...
int code;
{
	...
	if (port_nr >= 0 && port_nr < ICMP_PORT_NR)
...
/*
 * $PchId: icmp.c,v 1.7 1995/11/21 06:45:27 philip Exp $
 */
