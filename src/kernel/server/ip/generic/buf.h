...
#define bf_memreq(a) _bf_memreq(ip_panic_warning_file, __LINE__, a)
#define bf_cut(a,b,c) _bf_cut(ip_panic_warning_file, __LINE__, a, b, c)
#define bf_delhead(a,b) _bf_delhead(ip_panic_warning_file, __LINE__, a, b)
#define bf_packIffLess(a,b) _bf_packIffLess(ip_panic_warning_file, __LINE__, \
									a, b)
#define bf_afree(a) _bf_afree(ip_panic_warning_file, __LINE__, a)
#define bf_pack(a) _bf_pack(ip_panic_warning_file, __LINE__, a)
#define bf_append(a,b) _bf_append(ip_panic_warning_file, __LINE__, a, b)
#define bf_dupacc(a) _bf_dupacc(ip_panic_warning_file, __LINE__, a)
#define bf_mark_acc(a) _bf_mark_acc(ip_panic_warning_file, __LINE__, a)
#define bf_align(a,s,al) _bf_align(ip_panic_warning_file, __LINE__, a, s, al)
...
#define bf_chkbuf(buf) ((buf)? (compareN(0,(buf)->acc_linkC,>,0), \
	compareN(1,(buf)->acc_buffer, !=, 0), \
	compareN(2,(buf)->acc_buffer->buf_linkC,>,0)) : 0)
