/*	@(#)offset.c	1.2	94/04/06 09:30:52 */
/*
...
struct procseg procseg;
MKOFF( procseg,ps_pmeg,PS_PMEG );
MKOFF( procseg,ps_pte,PS_PTE );
MKSIZEOF( struct procseg,PROCSEG );

struct procmap procmap;
MKOFFARR( procmap,pm_seg,PM_SEG );
MKSIZEOF( struct procmap,PROCMAP );
