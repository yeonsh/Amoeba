...

{
  argc=oargc;
  argv=oargv;
  getargs();  /* sets i, believe it or not! */
...
#define ARGS	"chlnsve:f:"

void usage(progname)
char * progname;
{
    fprintf(stderr,"Usage: %s [-chlnsv]  [[-e special-string] | [-f file] | strings] [file] ...\n", progname);
    exit(2);
}
