...
**
*/
# define MALLOC		/* Use malloc/free, instead of sbrk -- see sh1.c */
 ...
 */
typedef long xint;	/* base type of jmp_buf, for broken compilers */
...
#ifdef AMOEBA
/* hack to make pwd work --Guido */
Extern	struct	var	*workdir;	/* work directory */
#endif
