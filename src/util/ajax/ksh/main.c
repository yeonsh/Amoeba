/*	@(#)main.c	1.4	96/02/27 13:03:17 */
/*
 * startup, main loop, enviroments and error handling
 */

#ifndef lint
static char *RCSid = "$Id: main.c,v 1.3 1994/11/14 09:06:59 versto Exp $";
#endif
...
#ifdef AMOEBA
	/* initialise _WORK used by path normalisation module */
	setstr(typeset("_WORK", EXPORT, 0), getenv("_WORK"));
#endif
