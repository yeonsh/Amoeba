/*	@(#)exec.c	1.4	96/02/27 13:02:19 */
/*
 * execute command tree
 */

#ifndef lint
static char *RCSid = "$Id: exec.c,v 1.3 1994/11/14 09:06:59 versto Exp $";
#endif
...
#else
		/* Amoeba has script execution support in execve itself */
#endif
		errorf("%s: %s\n", s, strerror(errno));
	}
...
#else
		/* On Amoeba directories containing 'pd.<arch>' binaries
		 * are also executable.
		 */
		if (i == 0 && (mode != 1 || (stat(line,&buf) == 0 &&
