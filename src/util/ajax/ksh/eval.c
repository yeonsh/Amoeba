/*	@(#)eval.c	1.3	96/02/27 13:02:11 */
/*
 * Expansion - quoting, separation, substitution, globbing
 */

#ifndef lint
static char *RCSid = "$Id: eval.c,v 1.3 1994/11/14 09:06:59 versto Exp $";
#endif
...
#else
    {
	static char userpath[PATH_MAX];
	DIR *dirp;

	(void) sprintf(userpath, "%s/%s/home", DEF_USERDIR, name);
	if ((dirp = opendir(userpath)) == NULL) {
		/* this user's home directory doesn't exists */
		return NULL;
	}
	closedir(dirp);
	return userpath;
