/*	@(#)io.c	1.4	96/02/27 13:02:48 */
/*
 * shell buffered IO and formatted output
 */

#ifndef lint
static char *RCSid = "$Id: io.c,v 1.3 1994/11/14 09:06:59 versto Exp $";
#endif
...
#ifdef __linux__
/*
 * Streams are buffered by default under Linux, and calling
 * setvbuf with buf == NULL unbuffers them. So this stub
 * just does a noop.
 */
	...
	int fd;
{
	if (shf[fd] != NULL)
		return;
#if !defined(_MINIX) && !defined(__linux__) && !defined(AMOEBA)
	if (fd <= 2)
