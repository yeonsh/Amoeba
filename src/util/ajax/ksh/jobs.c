/*	@(#)jobs.c	1.4	96/02/27 13:02:53 */
/*
 * Process and job control
 */
#ifndef lint
static char *RCSid = "$Id: jobs.c,v 1.4 1994/12/05 08:24:01 versto Exp $";
#endif
...
#else
		  /* We really need to ignore SIGINT since the process is
		   * not put in a seperate process group.
		   */
		  sigaction(SIGINT, &Sigact_ign, NULL);
		  sigaction(SIGQUIT, &Sigact_ign, NULL);
		  if (flag[FTALKING])
		    sigaction(SIGTERM, &Sigact_ign, NULL);
#endif
#else
