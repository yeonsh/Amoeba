/*	@(#)curses.c	1.1	94/08/31 10:37:51 */
/* curses.c */
...
/*
 * A few global termcap variables are defined in the Amoeba library itself.
 * The compiler might generate code that doesn't allow the loader to merge
