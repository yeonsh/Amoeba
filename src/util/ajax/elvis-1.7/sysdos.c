/*	@(#)sysdos.c	1.1	94/08/31 10:39:51 */
 ...
 *	rpipe(cmd, in)	- run a shell command with stdin/stdout piped
 *	rpclose(fd)	- close a pipe that was created via rpipe()
 *	gethome(argv0)	- return name of home directory
 *
