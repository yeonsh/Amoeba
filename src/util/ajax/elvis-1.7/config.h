/*	@(#)config.h	1.2	96/02/27 12:46:06 */
/*
...
#else
# ifdef sun
#  if !defined(M_SYSV) && !defined(AMOEBA)
#   define BSD		1
#  endif
# endif
#endif
...
#if !BSD && !UNIXV && !UNIX7 && !MSDOS && !TOS && !AMIGA && !OSK && !COHERENT && !VMS && !AMOEBA
# define MINIX	1
#else
# define MINIX	0
#endif
...
#if UNIXV || UNIX7 || BSD || MINIX || COHERENT || AMOEBA
# define ANY_UNIX 1
#else
# define ANY_UNIX 0
#endif
...
#ifdef AMOEBA
#define	PRSVDIR		"/dev/dead"
#define	PRSVINDEX	"/dev/dead/ElvisIndex"
#endif /* AMOEBA */
