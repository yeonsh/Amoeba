 ...
 */
    ...
    extern void _db_write_ ();		/* Print debug output, nothing else */
...
#    define DBUG_CATCH setjmp
#    define DBUG_END_CATCH()
# else
#    define DBUG_ENTER(a) \
	...
	_db_enter_ (a,__FILE__,__LINE__,&_db_func_,&_db_file_,&_db_level_, \
		    (char ***)&_db_framep_)
/* KV: (char ***) added to keep lint happy */
#    define DBUG_LEAVE \
...
/* added: */
#    define DBUG_WRITE(arglist) \
	{if (_db_on_) _db_write_ arglist;}
#    define DBUG_NL() DBUG_WRITE(("\n"))

extern void _db_catch_(), _db_end_catch_();
#    define DBUG_CATCH(a1) (_db_catch_ (), setjmp (a1))
#    define DBUG_END_CATCH() _db_end_catch_()
# endif
