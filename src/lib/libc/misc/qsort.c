...
static void qsort1     _ARGS((char *, char *, size_t));
static int (*qcompar)  _ARGS((const char *, const char *));
static void qexchange  _ARGS((char *, char *, size_t));
static void q3exchange _ARGS((char *, char *, char *, size_t));
...
int (*compar) _ARGS((const void *, const void *));
{
        ...
        if (!nel) return;
	qcompar = (int (*) _ARGS((const char *, const char *))) compar;
