...
#ifdef read
#undef read
#endif  /*Awful hack  ../../common/extra.h redefines read as a 2-arg macro.  Conflicts with unistd.h read def. */

#ifdef	X11WIN
/*X headers not posix compliant. */
#ifdef _POSIX_SOURCE
#undef _POSIX_SOURCE
#endif
#include <X11/Xlib.h>
